...
parametrage <- function (S){
  ...
  mat_rate = rbeta(S, 5,5) ## Loi beta, distribution piquée centrée en 8/13
  juv_surv = rbeta(S, 5,5) ## Loi beta, distribution piquée centrée en 8/13
  adult_surv = rbeta(S, 5,5) ## Loi beta, distribution piquée centrée en 8/13
