...
plot(liste_alpha, liste_beta, type = 'p', col = alpha("black", 0.25), pch = 16)

cairo_pdf("opposite_hier_alpha_beta.pdf")
plot(rank(liste_alpha), rank(liste_beta), xlab=expression('Rank of' ~ alpha[ij]), ylab=expression('Rank of' ~ beta[ij]), type = 'p', col = alpha("black", 0.4), pch = 16)
dev.off()

cairo_ps("opposite_hier_alpha_beta.eps")
plot(rank(liste_alpha), rank(liste_beta), xlab=expression('Rank of' ~ alpha[ij]), ylab=expression('Rank of' ~ beta[ij]), type = 'p', col = alpha("black", 0.4), pch = 16)
dev.off()
##
test_inv_score = c()
...
cairo_pdf("pairwise_interaction_opp_hier_only.pdf")
