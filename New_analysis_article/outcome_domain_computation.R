...
a <- ggplot(data=rect_ref, aes(x=c(0,0.5), y=c(0,0.5)))+
  ...
  xlab("alpha21")+ylab("alpha12")+ guides(fill=guide_legend(title="Outcome predicted by the invasion criteria"))+ggtitle("Only competition on fertility (only \u03B1)")+ 
...
b <- ggplot(data=rect_alpha_eq_beta, aes(x=c(0,0.5), y=c(0,0.5)))+
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  scale_fill_manual(values = c('grey',"white","grey20", "grey50"))+
  xlab("alpha21")+ylab("alpha12")+ guides(fill=guide_legend(title="Outcome predicted by the invasion criteria"))+ggtitle("\u03B2 = \u03B1")+ 
...
c <- ggplot(data=rect_coexistence, aes(x=c(0,0.5), y=c(0,0.5)))+
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  scale_fill_manual(values = c('grey',"white","grey20", "grey50"))+
  xlab("alpha21")+ylab("alpha12")+ guides(fill=guide_legend(title="Outcome predicted by the invasion criteria"))+ggtitle("\u03B2's suggests coexistence ")+ 
  theme(plot.title = element_text(size = 12, face = "bold"))+theme(legend.position = "none")
...
d <- ggplot(data=rect_exclu_sp2, aes(x=c(0,0.5), y=c(0,0.5)))+
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  scale_fill_manual(values = c('grey',"white","grey20", "grey50"))+
  xlab("alpha21")+ylab("alpha12")+ guides(fill=guide_legend(title="Outcome predicted by the invasion criteria"))+ggtitle("\u03B2's suggests exclusion of species 1")+ 
  theme(plot.title = element_text(size = 12, face = "bold"))+theme(legend.position = "none")
...
e <- ggplot(data=rect_priorityeffect, aes(x=c(0,0.5), y=c(0,0.5)))+
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  scale_fill_manual(values = c('grey',"white","grey20", "grey50"))+
  xlab("alpha21")+ylab("alpha12")+ guides(fill=guide_legend(title="Outcome predicted by the invasion criteria"))+ggtitle("\u03B2's suggests a priority effect")+ 
  theme(plot.title = element_text(size = 12, face = "bold"))+theme(legend.position = "none")
