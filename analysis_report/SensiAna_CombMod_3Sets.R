...
tab_param <- rbind(c(30,25,0.9,0.8,0.5,0.4,0.5,0.6, 0.1,0.08,0.045,0.1,0.1,0.07,0.055,0.1),
                   c(30,25,0.7,0.6,0.2,0.18,0.4,0.6, 0.05,0.04,0.07,0.1,0.1,0.08,0.04,0.06),
                   c(30,25,0.9,0.8,0.5,0.4,0.5,0.6, 0.06,0.07,0.055,0.04,0.1,0.07,0.055,0.1))


source("sensitivity_analysis_function.R")

### Computation of sensitivity and elasticity for the 3 parameter sets
...
#### Representation of elasticities
...
### Representation of coexistence domains

param_set_index = c(1,2,5)
for (i in 1:3){
